...
TARGET_DEVELOP_SKILL_DIR="$CODEX_HOME_DIR/skills/develop"
TARGET_PROMPT_DIR="$CODEX_HOME_DIR/prompts"

mkdir -p "$TARGET_SKILL_DIR" "$TARGET_DEVELOP_SKILL_DIR" "$TARGET_PROMPT_DIR"

cp "$REPO_ROOT/global/skills/permission-bootstrap/SKILL.md" "$TARGET_SKILL_DIR/SKILL.md"
cp "$REPO_ROOT/global/skills/develop/SKILL.md" "$TARGET_DEVELOP_SKILL_DIR/SKILL.md"
...
echo "Installed skill: $TARGET_DEVELOP_SKILL_DIR/SKILL.md"
