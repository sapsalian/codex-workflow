...
**Q&A 라운드 가이드라인 (전체 설계)**
- 전체 설계 Q&A는 **3라운드 필수**
- Q&A 목적은 기술 검토뿐 아니라 요구사항 구체화, 범위 확정, 성공 기준 합의까지 포함
- 3라운드 이후에도 파생 고려사항이 있으면 4라운드, 5라운드로 계속 진행

전체 설계 시 검토 체크리스트:
- 요구사항 구체화: 해결하려는 문제, 목표, 포함 범위, 제외 범위
- 사용자 시나리오: 누가 어떤 흐름으로 사용하는가
- 기대 결과/완료 기준: 무엇이 충족되면 완료로 볼 수 있는가
...
- 요구사항의 의미, 범위, 기대 동작, 성공 기준이 불명확하면 반드시 질문
...
- 기술 세부 설계뿐 아니라 해당 Phase의 기대 동작, 범위, 경계 조건을 구체화
- 라운드 시작 전 아래 체크리스트를 검토하고 고려사항 요약 출력

Phase 세부 설계 시 검토 체크리스트:
- Phase 요구사항 구체화: 이번 Phase에서 반드시 달성할 동작, 제외할 동작
- 성공 기준: 이 Phase가 완료됐다고 볼 수 있는 검증 가능 기준
